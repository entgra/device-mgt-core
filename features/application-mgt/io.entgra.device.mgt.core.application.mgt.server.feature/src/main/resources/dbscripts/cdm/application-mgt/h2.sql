...
CREATE TABLE IF NOT EXISTS AP_APP_RELEASE(
  ...
  INSTALLER_LOCATION VARCHAR(500) NOT NULL,
  ICON_LOCATION VARCHAR(100) NOT NULL,
  BANNER_LOCATION VARCHAR(100) NULL DEFAULT NULL,
  SC_1_LOCATION VARCHAR(100) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS AP_APP_DEVICE_MODEL (
    APP_ID INT NOT NULL,
    FIRMWARE_DEVICE_MODEL_ID INT NOT NULL,
    PRIMARY KEY (APP_ID, FIRMWARE_DEVICE_MODEL_ID),
    CONSTRAINT UNIQUE_FIRMWARE_DEVICE_MODEL_ID UNIQUE (FIRMWARE_DEVICE_MODEL_ID)
);