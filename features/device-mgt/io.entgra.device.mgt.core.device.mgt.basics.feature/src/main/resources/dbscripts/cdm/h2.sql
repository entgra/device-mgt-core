...
CREATE TABLE IF NOT EXISTS DM_NOTIFICATION_USER_ACTION (
    ...
    CONSTRAINT fk_dm_notification_user_action FOREIGN KEY (NOTIFICATION_ID) REFERENCES DM_NOTIFICATION (NOTIFICATION_ID) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS DM_DEVICE_TYPE_META (
    ...
    TENANT_ID INTEGER DEFAULT 0,
    PRIMARY KEY (ID),
    CONSTRAINT FK_DEVICE_TYPE_META FOREIGN KEY (DEVICE_TYPE_ID) REFERENCES DM_DEVICE_TYPE(ID),
