...
CREATE TABLE IF NOT EXISTS DM_NOTIFICATION (
    ...
    TENANT_ID INTEGER NOT NULL,
    NOTIFICATION_CONTEXT VARCHAR(1000) NULL,
    TYPE VARCHAR(20) NOT NULL,
...
CREATE TABLE IF NOT EXISTS DM_NOTIFICATION_DEVICE (
...
CREATE TABLE IF NOT EXISTS DM_NOTIFICATION_USER_ACTION (
    ...
    CONSTRAINT fk_dm_notification_user_action FOREIGN KEY (NOTIFICATION_ID)
        REFERENCES DM_NOTIFICATION (NOTIFICATION_ID) ON DELETE CASCADE
);

CREATE INDEX IDX_DM_NOTIFICATION_USER_ACTION_TIMESTAMP ON DM_NOTIFICATION_USER_ACTION(ACTION_TIMESTAMP);
...
-- DM_DEVICE_FIRMWARE_MODEL TABLE--
CREATE TABLE IF NOT EXISTS DM_DEVICE_FIRMWARE_MODEL (
    ID INTEGER AUTO_INCREMENT NOT NULL,
    FIRMWARE_MODEL VARCHAR(100) NOT NULL,
    DESCRIPTION VARCHAR(200) NULL DEFAULT NULL,
    DEVICE_TYPE_ID INTEGER NOT NULL DEFAULT 0,
    TENANT_ID INTEGER NOT NULL DEFAULT 0,
    PRIMARY KEY (ID),
    CONSTRAINT FK_DM_DEVICE_FIRMWARE_MODEL_DM_DEVICE_TYPE FOREIGN KEY (DEVICE_TYPE_ID)
    REFERENCES DM_DEVICE_TYPE(ID) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB;
-- END OF  DM_DEVICE_FIRMWARE_MODEL  TABLE--

-- DM_DEVICE_FIRMWARE_MODEL_MAPPING TABLE--
CREATE TABLE IF NOT EXISTS DM_DEVICE_FIRMWARE_MODEL_MAPPING (
    DM_DEVICE_ID INTEGER AUTO_INCREMENT NOT NULL,
    FIRMWARE_MODEL_ID INTEGER(100) NOT NULL,
    TENANT_ID INTEGER NOT NULL DEFAULT 0,
    FIRMWARE_VERSION VARCHAR(100) NULL DEFAULT NULL,
    PRIMARY KEY (DM_DEVICE_ID, FIRMWARE_MODEL_ID),
    CONSTRAINT FK_DM_DEVICE_FIRMWARE_MODEL_MAPPING_DM_DEVICE FOREIGN KEY (DM_DEVICE_ID)
    REFERENCES DM_DEVICE (ID) ON DELETE NO ACTION ON UPDATE NO ACTION,
    CONSTRAINT FK_DM_DEVICE_FIRMWARE_MODEL_MAPPING_DM_FIRMWARE_MODEL FOREIGN KEY (FIRMWARE_MODEL_ID)
    REFERENCES DM_DEVICE_FIRMWARE_MODEL (ID) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB;
-- END OF  DM_DEVICE_FIRMWARE_MODEL_MAPPING  TABLE--
...
CREATE TABLE IF NOT EXISTS DM_DEVICE_TYPE_META (
    ID INTEGER AUTO_INCREMENT NOT NULL,
    DEVICE_TYPE_ID INTEGER NOT NULL,
    META_KEY VARCHAR(100) NOT NULL,
    META_VALUE VARCHAR(20000),
    LAST_UPDATED_TIMESTAMP BIGINT NOT NULL,
    TENANT_ID INTEGER DEFAULT 0,
    PRIMARY KEY (ID),
    FOREIGN KEY (DEVICE_TYPE_ID) REFERENCES DM_DEVICE_TYPE(ID),
    UNIQUE KEY UK_DM_DEVICE_TYPE_META (DEVICE_TYPE_ID, TENANT_ID, META_KEY)
    );
-- END OF DM_DEVICE_TYPE_META TABLE --

-- DM_OPERATION_DETAILS TABLE --
CREATE TABLE IF NOT EXISTS DM_OPERATION_DETAILS (
    ID INTEGER AUTO_INCREMENT NOT NULL,
    OPERATION_CODE VARCHAR(50) NOT NULL,
    ...
    PRIMARY KEY (ID),
    UNIQUE (OPERATION_CODE, DEVICE_TYPE)
    ) ENGINE = InnoDB;
