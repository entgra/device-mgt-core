...
CREATE SEQUENCE DM_NOTIFICATION_USER_ACTION_seq;

CREATE TABLE IF NOT EXISTS DM_NOTIFICATION_USER_ACTION (
    ACTION_ID INTEGER DEFAULT NEXTVAL('DM_NOTIFICATION_USER_ACTION_seq') NOT NULL,
    NOTIFICATION_ID INTEGER NOT NULL,
...
-- Sequence for DM_DEVICE_TYPE_META table
CREATE SEQUENCE DM_DEVICE_TYPE_META_seq;

-- DM_DEVICE_TYPE_META TABLE --
CREATE TABLE IF NOT EXISTS DM_DEVICE_TYPE_META (
    ID INTEGER DEFAULT NEXTVAL('DM_DEVICE_TYPE_META_seq') NOT NULL,
