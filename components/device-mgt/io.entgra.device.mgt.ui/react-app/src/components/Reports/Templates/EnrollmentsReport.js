...
class EnrollmentsReport extends React.Component {
                ...
                <PageHeader style={{paddingTop: 0}}>
                    ...
                    <div className="wrap" style={{marginBottom: '10px'}}>
                        ...
                        <div style={{marginBottom: '10px'}}>
                            ...
                            <Select defaultValue="enrollements" style={{ width: 120 , marginRight:10}}>
                                <Option value="enrollements">Enrollments</Option>
                                <Option value="unenrollments">Unenrollments</Option>
                            </Select>
