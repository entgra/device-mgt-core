        ...
        info = @Info(
                ...
                extensions = {
                        @Extension(properties = {
                                ...
                                @ExtensionProperty(name = "context", value = "/api/device-mgt/v1.0/device-types/metadata"),
                        })
                }
        ),
        tags = {
...
public interface DeviceTypeMetaDataManagementService {
    ...
    Response createMetaEntry(
            ...
            @ApiParam(name = "metaKey", value = "The metadata key to be created.", required = true)
            @QueryParam("metaKey") String metaKey,

            @ApiParam(name = "metaValue", value = "The value corresponding to the metadata key.", required = true)
    ...
    Response updateMetaEntry(
            ...
            @ApiParam(name = "metaKey", value = "The metadata key to be updated.", required = true)
            @QueryParam("metaKey") String metaKey,

            @ApiParam(name = "metaValue", value = "The new value to be associated with the metadata key.", required = true)
            @QueryParam("metaValue") String metaValue
    );
