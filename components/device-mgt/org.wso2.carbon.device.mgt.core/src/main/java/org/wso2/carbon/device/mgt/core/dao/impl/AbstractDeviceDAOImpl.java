...
public abstract class AbstractDeviceDAOImpl implements DeviceDAO {
    ...
    @Override
    public Device getDevice(String deviceIdentifier, String owner, int tenantId)
            throws DeviceManagementDAOException {
        Connection conn;
        PreparedStatement stmt = null;
        ResultSet rs = null;
    ...
    @Override
    public Device getDevice(String deviceIdentifier, String owner, Date since, int tenantId)
            throws DeviceManagementDAOException {
        Connection conn;
        PreparedStatement stmt = null;
        ResultSet rs = null;
