...
public class OracleDeviceFeatureOperationDAOImpl implements DeviceFeatureOperationDAO {
    ...
    public List<DeviceFeatureInfo> getOperationDetails(String code, String name, String type,
        ...
        try {
            ...
            String msg = "Error retrieving filtered operation details from Oracle DB.";
            log.error(msg, e);
            throw new DeviceManagementDAOException(msg, e);
        }
    ...
    public Map<String, Boolean> operationCodesExist(List<String> codes) throws DeviceManagementDAOException {
        ...
        try (Connection connection = DeviceFeatureOperationsDAOFactory.getConnection();
            ...
            for (int i = 0; i < codes.size(); i++) {
                stmt.setString(i + 1, codes.get(i).toUpperCase());
            ...
            throw new DeviceManagementDAOException("Error checking operation codes in Oracle.", e);
        }
        return result;
    }
}
