...
public class H2DeviceFeatureOperationDAOImpl implements DeviceFeatureOperationDAO {
    private static final Log log = LogFactory.getLog(H2DeviceFeatureOperationDAOImpl.class);
    ...
    public void updateDeviceFeatureDetails(List<DeviceFeatureInfo> featureList) throws DeviceManagementDAOException {
        ...
        try {
            ...
            String msg = "Error occurred while updating device feature details in H2.";
            log.error(msg, e);
