...
public class PostgreNotificationManagementDAOImpl implements NotificationManagementDAO {
    ...
    public int getNotificationActionsCountByUser(String username, Boolean isRead)
        ...
        try {
            ...
            String msg = "PostgreSQL DB error counting user notifications";
            log.error(msg, e);
            throw new NotificationManagementException(msg, e);
        }
        return 0;
    ...
    public void deleteUserNotifications(List<Integer> notificationIds, String username)
        ...
        try {
            ...
            String msg = "Error occurred while deleting notifications for user: " + username + " (PostgreSQL)";
            log.error(msg, e);
            throw new NotificationManagementException(msg, e);
        }
    }
    ...
    public void deleteAllUserNotifications(String username) throws NotificationManagementException {
        ...
        try {
            ...
            String msg = "Error occurred while deleting all notifications for user (PostgreSQL): " + username;
            log.error(msg, e);
            throw new NotificationManagementException(msg, e);
        }
    }
