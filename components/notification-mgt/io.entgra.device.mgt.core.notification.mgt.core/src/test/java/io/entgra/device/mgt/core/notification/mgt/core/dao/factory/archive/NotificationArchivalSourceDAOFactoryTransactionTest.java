...
public class NotificationArchivalSourceDAOFactoryTransactionTest {
    ...
    public void beginTransactionRespectsExistingConnection(String scenario) throws Exception {
        Object target = null;
        Field sourceField = NotificationArchivalSourceDAOFactory.class.getDeclaredField("dataSource");
        Field currentField = NotificationArchivalSourceDAOFactory.class.getDeclaredField("currentConnection");
        ...
        try {
            ...
            try {
                NotificationArchivalSourceDAOFactory.class.getMethod("beginTransaction").invoke(target);
